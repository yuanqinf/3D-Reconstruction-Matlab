...
function xdetect = mapgrid(I,nx,ny)
...
% canonical order.
%
% WARNING: This code assumes the grid of points is Nx x Ny and
...
[yd,xd] = meshgrid(linspace(0,1,ny),linspace(0,1,nx));
